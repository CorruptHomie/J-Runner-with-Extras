...
namespace JRunner
{
    ...
    public partial class MainForm
    {
        ...
        private void SetupCustomChrome()
        {
            ...
            // Reflects the saved setting without re-entering the handler's save path.
            backgroundSnowToolStripMenuItem.Checked = variables.snowfallEnabled;
        }
        ...
        private void backgroundSnowToolStripMenuItem_CheckedChanged(object sender, EventArgs e)
        {
            variables.snowfallEnabled = backgroundSnowToolStripMenuItem.Checked;
            // Repaint straight away so ticking the box clears the glyphs immediately rather
            // than leaving whatever was last drawn sitting there.
            if (_snowfall != null) _snowfall.Refresh();
        }
